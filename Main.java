...
class Main {
  public static void main(String[] args) {
    ...
    b.setI(50);
    System.out.println(a); // Will print out new value of 50 even though you are calling for a. Working off the same class so the value is changing due to method setI.
  }
}